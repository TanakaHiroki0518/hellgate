...
int		enemy_main(ADV_MAIN	*lpsprEn[enemy_h][enemy_w],ADV_MAIN *lpsprPl,CHARA_MAIN player,int map_c,int dash_c,ADV_MAIN *lpsprGate)
{
	...
	for(l = 0;l < enemy_h;l++)
	{
		for(o = 0;o < enemy_w;o++)
		{
			...
			{
				greatkoshika = 0;
				LoadDivGraph(L"graphic/player.PNG",lpsprPl->allnum,lpsprPl->x_num,lpsprPl->y_num,lpsprPl->w,lpsprPl->h,lpsprPl->sprNo);
			}
			...
			if((lpsprPl->y > lpsprEn->y - enemy_hani) && (lpsprPl->y < lpsprEn->y + enemy_hani))
			{
				...
				if((lpsprPl->x < lpsprEn->x + maptip_size - 7) && (lpsprPl->x > lpsprEn->x - maptip_size + 7))
				{
					if((lpsprPl->y < lpsprEn->y + maptip_size) && (lpsprPl->y > lpsprEn->y - maptip_size))
					{
						...
						{
							player.hp -= enemy_atp;
							LoadDivGraph(L"graphic/player_dmg.PNG",lpsprPl->allnum,lpsprPl->x_num,lpsprPl->y_num,lpsprPl->w,lpsprPl->h,lpsprPl->sprNo);
							lpsprEn->dmg = 1;
						}
					}
				}
				if(lpsprEn->dmg != 1)
				{
					if((lpsprEn->x > (lpsprGate->x + lpsprGate->w)) || (lpsprEn->x < (lpsprGate->x - lpsprEn->w)) || (lpsprEn->y > (lpsprGate->y + lpsprGate->h)) || (lpsprGate->show_num != 0) || (lpsprGate->g_show != GRA_ON))
					{
						if(lpsprPl->x < lpsprEn->x)
						{
							...
							LoadDivGraph(L"graphic/enemy.PNG",lpsprEn->allnum,lpsprEn->x_num,lpsprEn->y_num,lpsprEn->w,lpsprEn->h,lpsprEn->sprNo);
						}
						else if(lpsprPl->x > lpsprEn->x)
						{
							SprMove(lpsprEn,enemy_s,0);
							LoadDivGraph(L"graphic/enemy_right.PNG",lpsprEn->allnum,lpsprEn->x_num,lpsprEn->y_num,lpsprEn->w,lpsprEn->h,lpsprEn->sprNo);
						}
				...
				if((lpsprEn[l][o]->x > lpsprEn[0][1]->x - enemy_koshika) && (lpsprEn[l][o]->x < lpsprEn[0][1]->x + enemy_koshika))
				{
					if((lpsprEn[l][o]->y > lpsprEn[0][1]->y - enemy_koshika) && (lpsprEn[l][o]->y < lpsprEn[0][1]->y + enemy_koshika))
					{
						if(lpsprEn[l][o]->x < lpsprEn[0][1]->x)
						{
							...
							LoadDivGraph(L"graphic/enemy.PNG",lpsprEn[0][1]->allnum,lpsprEn[0][1]->x_num,lpsprEn[0][1]->y_num,lpsprEn[0][1]->w,lpsprEn[0][1]->h,lpsprEn[0][1]->sprNo);
						}
						else if(lpsprEn[l][o]->x > lpsprEn[0][1]->x)
						{
							SprMove(lpsprEn[0][1],-2,0);
							LoadDivGraph(L"graphic/enemy_right.PNG",lpsprEn[0][1]->allnum,lpsprEn[0][1]->x_num,lpsprEn[0][1]->y_num,lpsprEn[0][1]->w,lpsprEn[0][1]->h,lpsprEn[0][1]->sprNo);
						}
				...
				if((lpsprEn[l][o]->x > lpsprEn[1][0]->x - enemy_koshika) && (lpsprEn[l][o]->x < lpsprEn[1][0]->x + enemy_koshika))
				{
					if((lpsprEn[l][o]->y > lpsprEn[1][0]->y - enemy_koshika) && (lpsprEn[l][o]->y < lpsprEn[1][0]->y + enemy_koshika))
					{
						if(lpsprEn[l][o]->x < lpsprEn[1][0]->x)
						{
							...
							LoadDivGraph(L"graphic/enemy.PNG",lpsprEn[1][0]->allnum,lpsprEn[1][0]->x_num,lpsprEn[1][0]->y_num,lpsprEn[1][0]->w,lpsprEn[1][0]->h,lpsprEn[1][0]->sprNo);
						}
						else if(lpsprEn[l][o]->x > lpsprEn[1][0]->x)
						{
							SprMove(lpsprEn[1][0],-1,0);
							LoadDivGraph(L"graphic/enemy_right.PNG",lpsprEn[1][0]->allnum,lpsprEn[1][0]->x_num,lpsprEn[1][0]->y_num,lpsprEn[1][0]->w,lpsprEn[1][0]->h,lpsprEn[1][0]->sprNo);
						}
				...
				if((lpsprEn[l][o]->x > lpsprEn[1][1]->x - enemy_koshika) && (lpsprEn[l][o]->x < lpsprEn[1][1]->x + enemy_koshika))
				{
					if((lpsprEn[l][o]->y > lpsprEn[1][1]->y - enemy_koshika) && (lpsprEn[l][o]->y < lpsprEn[1][1]->y + enemy_koshika))
					{
						if(lpsprEn[l][o]->x < lpsprEn[1][1]->x)
						{
							...
							LoadDivGraph(L"graphic/enemy.PNG",lpsprEn[1][1]->allnum,lpsprEn[1][1]->x_num,lpsprEn[1][1]->y_num,lpsprEn[1][1]->w,lpsprEn[1][1]->h,lpsprEn[1][1]->sprNo);
						}
						else if(lpsprEn[l][o]->x > lpsprEn[1][1]->x)
						{
							SprMove(lpsprEn[1][1],-1,0);
							LoadDivGraph(L"graphic/enemy_right.PNG",lpsprEn[1][1]->allnum,lpsprEn[1][1]->x_num,lpsprEn[1][1]->y_num,lpsprEn[1][1]->w,lpsprEn[1][1]->h,lpsprEn[1][1]->sprNo);
						}
